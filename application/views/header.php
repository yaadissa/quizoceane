<html lang="en">
  ...
  <title><?php echo $title;?></title>
	...
	<!-- custom css -->	
	<link href="<?php echo base_url('css/AdminLTE.min');?>" rel="stylesheet">
	<link href="<?php echo base_url('css/skin-yellow.min');?>" rel="stylesheet">
	...
	<img src="<?php echo base_url('images/logo.png');?>">
        ...
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <!--  <a class="navbar-brand" href="http://www.oceaneconsulting.com"><?php echo $this->lang->line('savsoft_quiz');?></a>-->
          </div>
...
?>				 <li><a href="<?php echo site_url('quiz');?>"><?php echo $this->lang->line('quiz');?> <?php echo $this->lang->line('list');?></a></li>
			...
			<?php 
             ...
             <ul class="nav navbar-nav navbar-right">
             	<li><a href="<?php echo site_url('user/logout');?>"><span class="glyphicon glyphicon-log-in"></span> <?php echo $this->lang->line('logout');?></a></li>
    		</ul>
          </div><!--/.nav-collapse -->
        </div><!--/.container-fluid -->
      </nav>

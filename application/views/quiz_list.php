...
<th><?php echo $this->lang->line('start_date_s');?></th>
<th><?php echo $this->lang->line('end_date_s');?></th>
...
foreach($result as $key => $val){
		$classy='';
	if(( $val['start_date'] < time() &&  time() < $val['end_date'] ) || $logged_in['su']==1){
		if((time() < $val['start_date']  || time() > $val['end_date'] )){
		$classy='danger';
	}
?>
...
<td><?php echo date('d-m-Y H:i:s',$val['start_date']);?></td>
<td><?php echo date('d-m-Y H:i:s',$val['end_date']);?></td>
 <td>
